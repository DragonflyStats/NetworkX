...
# of the 'observed' scores fall below any one score, then the z score that would fit that proportion
# if the data were normally distributed is calculated, and finally that z score that would cut off 
